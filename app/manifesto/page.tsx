      ...
      <main>
        ...
        <section className="section-dark relative">
          <div className="max-w-content mx-auto text-center">
            <h1 className="heading-display text-manifesto-h1 text-primary mb-6">
              The<br />Humanifesto
            </h1>
        ...
        <section className="section-primary">
          <div className="max-w-content mx-auto text-center">
            <h2 className="heading-display text-manifesto-h2 mb-4">
        ...
        <section className="section-dark">
          <div className="max-w-content-wide mx-auto text-center">
            <h2 className="heading-display text-manifesto-h2 text-primary mb-4">
        ...
        <section className="section-dark">
          <div className="max-w-content mx-auto text-center">
            ...
            <div className="inline-block border border-primary px-4 py-2 mb-10">
              <p className="font-mono text-manifesto-h6 font-bold uppercase text-primary">04. Real Impact</p>
            </div>
