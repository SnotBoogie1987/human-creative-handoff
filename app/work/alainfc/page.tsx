...
export const metadata = {
  title: 'Al Ain FC | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Al Ain FC football club production.',
}

export default function AlAinFCPage() {
  return (
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Al Ain FC Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Al Ain FC football club production,
                supporting one of the UAE&apos;s most successful football clubs with experienced sports content creators.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Al Ain FC</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Football club content production</li>
                <li>Sports media specialists</li>
                <li>Match day coverage support</li>
              </ul>
            </div>
          </div>
