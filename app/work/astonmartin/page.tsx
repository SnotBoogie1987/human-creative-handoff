...
export const metadata = {
  title: 'Aston Martin | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Aston Martin luxury automotive production.',
}
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Aston Martin Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Aston Martin luxury automotive production,
                delivering top-tier creative talent for one of the world&apos;s most prestigious automotive brands.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Aston Martin</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Luxury automotive content production</li>
                <li>Brand campaign crew placement</li>
                <li>High-end commercial specialists</li>
              </ul>
            </div>
          </div>
