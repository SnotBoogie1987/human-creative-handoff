...
export const metadata = {
  title: 'Azimuth | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Azimuth production.',
}

export default function AzimuthPage() {
  return (
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Azimuth Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Azimuth production,
                supporting creative content development with skilled production professionals.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Azimuth</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Content production crew</li>
                <li>Creative specialists</li>
