...
export const metadata = {
  title: 'Lauryn Hill | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Lauryn Hill production.',
}
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Lauryn Hill Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Lauryn Hill production,
                supporting the legendary artist with top-tier music production and creative content specialists.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Lauryn Hill</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Music production crew</li>
                <li>Artist content specialists</li>
                <li>Live performance support</li>
              </ul>
            </div>
          </div>
