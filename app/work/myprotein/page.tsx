...
export const metadata = {
  title: 'Myprotein | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Myprotein brand production.',
}
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Myprotein Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Myprotein brand production,
                supporting the UK&apos;s leading sports nutrition brand with top creative and commercial talent.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Myprotein</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-lg">
                ...
                <li>Commercial crew placement</li>
                <li>Sports nutrition campaign support</li>
              </ul>
            </div>
          </div>
