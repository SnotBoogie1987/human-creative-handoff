...
export const metadata = {
  title: 'Nike Wellfest | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Nike Wellfest event production.',
}

export default function NikeWellfestPage() {
  return (
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Nike Wellfest Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Nike Wellfest event production,
                supporting Nike&apos;s wellness festival with experienced event and brand activation specialists.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Festival event production</li>
                <li>Brand activation crew</li>
                <li>Wellness event support</li>
              </ul>
            </div>
          </div>
