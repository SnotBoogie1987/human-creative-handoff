...
export const metadata = {
  title: 'Tough Mudder | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Tough Mudder obstacle course event production.',
}

export default function ToughMudderPage() {
  return (
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Tough Mudder Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Tough Mudder obstacle course event production,
                supporting the world&apos;s premier endurance challenge series with skilled action sports crew.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Tough Mudder</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Event production crew</li>
                <li>Action sports content specialists</li>
                <li>Obstacle course coverage support</li>
              </ul>
            </div>
          </div>
