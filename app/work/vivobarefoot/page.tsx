...
export const metadata = {
  title: 'Vivobarefoot | WORK | HUMAN. Creative',
  description: 'HUMAN. Creative provided exceptional freelancers for Vivobarefoot brand production.',
}

export default function VivobarefootPage() {
  return (
      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="aspect-video bg-gray-800 flex items-center justify-center text-gray-600 mb-8">
            <span className="text-sm">[Vivobarefoot Hero Image]</span>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-lg leading-relaxed">
                HUMAN. Creative provided exceptional freelancers for Vivobarefoot brand production,
                supporting innovative minimalist footwear brand storytelling and content creation.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Client</h3>
              <p className="text-lg">Vivobarefoot</p>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-2">Services Provided</h3>
              <ul className="list-disc list-inside space-y-2 text-lg">
                <li>Brand content production crew</li>
                <li>Sustainable fashion specialists</li>
                <li>Product campaign support</li>
              </ul>
            </div>
          </div>
